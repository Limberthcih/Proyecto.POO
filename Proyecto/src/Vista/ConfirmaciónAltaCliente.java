 ...
 * @author limberth
 */
public class ConfirmaciónAltaCliente extends javax.swing.JFrame {

    /**
     * Creates new form ConfirmaciónBajaCliente
     */
    public ConfirmaciónAltaCliente() {
        initComponents();
...
//AltaCliente(); checar linea 178     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmaciónAltaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmaciónAltaCliente().setVisible(true);
            }
        });
    }
